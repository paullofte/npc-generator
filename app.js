...
const npcNoun = ["gypsy", "missionary", "villager", "mediator", "performer", "witch", "outcast", "magus", "crook", "magister", "merchant", "mercenary", "conscript", "civilian", "serf", "expert", "caretaker", "worker", "activist", "brute", "commoner", "hermit", "actor", "hero", "inquisitor", "judge", "orator", "herald", "champion", "lord", "ranger", "chieftain", "highwayman", "cleric", "villain", "occultist", "pioneer", "fortune-hunter", "slave", "professor", "reverend", "burglar", "governor", "gunman", "servant", "thug", "vicar", "scrapper", "clairvoyant", "charmer", "drifter", "officer", "monk", "patriarch", "globetrotter", "journeyman", "explorer", "homemaker", "shopkeeper", "sniper", "statesman", "warden", "recluse", "crone", "courtier", "astrologer", "outlaw", "steward", "adventurer", "priest", "duelist", "adept", "polymath", "soldier", "tradesman", "jack-of-all-trades", "bum", "magician", "entertainer", "hit-man", "aristocrat", "sorcerer", "traveler", "craftsman", "wizard", "preacher", "laborer", "vagrant", "scientist", "beggar", "artisan", "master", "apprentice", "ascetic", "tradesman", "rogue", "ascendant", "politician", "superior", "warrior", "shepherd", "undertaker", "actor", "cook", "teacher", "fisherman",
"botanist", "bard", "tailor", "miner", "author", "maid", "butler", "blacksmith", "administrator", "obligator", "minister", "messenger", "guard", "gladiator", "alchemist", "king", "queen", "prince/princess", "lord/lady", "wizard", "warlock", "disguised fey" ];

const npcPowerLevel = [{
    level: "Ordered", 'muchWeaker': 2, 'slightlyWeaker': 10, 'comparable': 90, 'slightlyStronger': 98, 'muchStronger': 100
}, {
    level: "Calm", 'muchWeaker': 4, 'slightlyWeaker': 15, 'comparable': 85, 'slightlyStronger': 96, 'muchStronger': 100
}, {
...
const npcCharacteristic= ["Muscular", "Lots of tattoos", "Very Neat/Tidy", "Clumsy", "Very Tall", "Piercings", "Fidgets",
     "Smokes Pipe", "Always Reading", "Missing Finger", "Extravagant Clothing", "Falls Asleep", "Lots of Jewelery",
"Covered in Dirt", "Always Eating", "Very Short", "Always Sketching", "Attractive", "Diseased", "Ill", "Lean", "Obese",
"Plain", "Ugly", "Very Young", "Very Old", "Addicted", "Prominent Scar"];

const npcSpeech=["High Pitched", "Excited", "Always whispers", "Nasal", "Gruff", "Breathy", "Stutters", "Fast-talker", "Tense",
"Thick Accent", "Sing-song voice", "Dark tone", "Aggressive", "Complex Vocab", "Slow, Deep Voice", "Lisp", "Relaxed", "Booming Voice",
"Never Lies", "Never Tells Truth", "Third Person", "Boastful", "Boring", "Bossy", "Bubbly", "Calm", "Negotiates Everything", "impolite",
"high born", "incoherent", "loquacious", "Bravado", "Fatherly/Motherly", "Morbid", "Nihilistic", "Easily Distracted/Scattered", "Possessed"]

const npcRace=["Aarakocra", "Aasimar", "Humanoid", "Bugbear", "Centaur", "Humanoid", "Changeling", "Dhampir", "Humanoid","Dragon",
"Dragonborn", "Dwarf", "Humanoid", "Elf", "Firblog", "Humanoid", "Genasi", "Gith", "Humanoid","Devil",
"Gnome", "Goblin", "Humanoid", "Goliath", "half-elf", "half-orc","Humanoid", "Hobgoblin", "Human","Dragon",
"Kalashtar", "Kenku", "humanoid", "Kobold", "Leonin", "Humanoid", "Lizardfolk", "Loxodon", "Minotaur", "Humanoid","Demon",
"Orc", "Satyr", "humanoid", "Shifter", "Simic Hybrid", "Humanoid", "Tabaxi", "Tiefling", "Humanoid","Dragon","Construct",
"Tortle", "Triton", "Humanoid", "Vedalkin", "Verdan", "Warforged", "Yan-Ti", "Dau (KP)", "Chernomoi (KP)", "Humanoid","Devil",
"Burrowling (KP)", "Aridni (KP)", "Humanoid", "Bearfolk (KP)", "Caelmarans (KP)", "Humanoid", "Cantonal Dwarf (KP)", "Duergar","Dragon",
"Darakhul", "Dornigfolk", "Humanoid","Goblin (Dust)", "Gearforged", "Humanoid","Gnoll", "Kushites", "Humanoid","Devil",
    "Magdar", "Dwarf (Northland)", "Humanoid","Ravenfolk", "Elf (river)", "Humanoid","Roshgazi", "Septimes", "Humanoid","Dragon",
    "Elf (Shadow)", "Fey (Shadow)", "Humanoid","Trollkin", "Winterfolk", "Humanoid","Elf (Windrunner)", "Ratfolk", "Humanoid","Demon",
    "Awakened Beast Tiny", "Awakened Beast Small", "Humanoid","Awakened Beast Medium", "Awakened Beast Large", "Humanoid","Dragon",
    "Awakened Beast Huge", "Demon", "Humanoid", "Devil", "Ghost", "Humanoid", "Halfling","Devil","Construct",
    "Dwarf (Cloud)", "Dwarf (Guardian)", "Humanoid","Dwarf (Hill)", "Dwarf (March)", "Humanoid","Dwarf (Mountain)", "Dwarf (Tome)", "Humanoid","Dragon",
    "Elf (Ghost)", "Elf (Grey)", "Humanoid","Elf (Highborn)", "Elf (Light)", "Humanoid","Elf (Luathaigh)", "Elf (Sap)", "Humanoid","Devil",
    "Elf (Wood)", "Elf (wild)", "Humanoid","Elf (Wraith)", "Gnome (River)", "Humanoid"," Gnome (Rock)", "Halfling (Lightfoot)", "Humanoid","Dragon",
    "Halfling (Surefoot)", "Halfling (Trickfinger)", "Humanoid","Halfling (Wiseheart)", "", "Humanoid","Derro", "Imp", "Humanoid","Devil",
    "Cyclopse", "Dryad", "Humanoid","Hag", "Ghoul", "Humanoid","Undead Humanoid", "Pixie", "Humanoid","Dragon",
    "Reptilian", "Troll", "Humanoid","Giant (Hill)", "Giant", "Humanoid","Feyfolk", "Giant (Mountain)", "Humanoid","Demon",
    "Devil", "Doppleganger", "Humanoid","Blight", "Cultist", "Humanoid","Banshee", "Angel", "Humanoid",
    "Awakened Plant", "Magical Item", "Humanoid","Aboleth", "Aldani", "Humanoid","Barghest", "Basilisk", "Humanoid","Beholder", "werewolf", "Humanoid",
    "Darkling", "Death Knight", "Humanoid","Giant (Storm)", "Construct", "Humanoid","werebear", "wereboar", "Humanoid","wererat", "weretiger", "Humanoid",
    "mind flayer", "olithid", "Humanoid","Naga", "pegasus", "Humanoid","redcap", "skeleton", "Humanoid","Quickling", "unicorn", "Humanoid",
    "specter", "sprite", "Humanoid", "treant", "wight", "Humanoid", "wraith", "yakfolk", "Humanoid","zombie", "vampire humanoid", "Humanoid",
]
...
function getMood(roll, feeling) {

    if (feeling.withdrawn >= roll + 1) return 'Withdrawn';
    if (feeling.guarded >= roll + 1) return 'Guarded';
    if (feeling.cautious >= roll + 1) return 'Cautious';
    if (feeling.neutral >= roll + 1) return 'Neutral';
    if (feeling.sociable >= roll + 1) return 'Sociable';
    if (feeling.helpful >= roll + 1) return 'Helpful';
    if (feeling.forthcoming >= roll + 1) return 'Forthcoming';
    return 'Unknown'
}
...
function getPowerLevel(pl, pt) {
    const level = pl ? Number.parseInt(pl) :  dN(5)
...
function getFavor(fl, flm) {
    const level = fl ? Number.parseInt(fl) :  dN(conversationMood.length)
...
function generate(params) {
    const npcM = params?.get('m') ?? dN(npcModifier.length);
    const npcN = params?.get('n') ?? dN(npcNoun.length);
    const npcMN1 = params?.get('mn1');
    const npcMN2 = params?.get('mn2');
    const npcMN3 = params?.get('mn3');
    const npcMV1 = params?.get('mv1');
    const npcMV2 = params?.get('mv2');
    const npcMV3 = params?.get('mv3');
    const npcPL = params?.get('pl');
    const npcPT = params?.get('pt');
    const npcBL = params?.get('bl');
    const npcBT = params?.get('bt');
    const npcF = params?.get('f');
    const npcNA = params?.get('na');
    const npcPLA = params?.get('pla');
    const npcFL = params?.get('fl');
    const npcFLM = params?.get('flm');
    const npcST = params?.get('st');
    const npcSP = params?.get('sp') ?? dN(npcSpeech.length);
    const npcCH = params?.get('ch') ?? dN(npcCharacteristic.length);
    const npcR = params?.get('r') ?? dN(npcRace.length);
